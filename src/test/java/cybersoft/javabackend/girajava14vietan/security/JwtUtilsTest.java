package cybersoft.javabackend.girajava14vietan.security;
...
import cybersoft.javabackend.girajava14vietan.security.dto.CustomUserDetails;
...
public class JwtUtilsTest {
	...
	@Test
	public void shouldInjectJwtUtilSucessfully() {
		assertNotEquals(utils, null);
	}
	
	@Test
	public void shoudGenerateJwtTokenSuccessfully() {
	...
	public void shouldValidateInCorrectToken() {
		String token = "hoancoi.phuongmap.tuanheop";
