package cybersoft.javabackend.girajava14vietan.security.service;
...
import cybersoft.javabackend.girajava14vietan.common.exception.IncorrectLoginException;
...
public class AuthServiceImpl implements AuthService{
	...
	public String login(LoginDTO dto) {
		...
		//1. search user by username and password
		 Optional<LoginDTO> userOpt = userRepository.findByUsernameAndPassword(dto.getUsername(), dto.getPassword());
